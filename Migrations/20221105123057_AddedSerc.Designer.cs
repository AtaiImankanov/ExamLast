...
namespace homework_64_Atai.Migrations
{
    ...
    [Migration("20221105123057_AddedSerc")]
    partial class AddedSerc
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("homework_64_Atai.Models.ServiceCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("homework_64_Atai.Models.ServiceUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("homework_64_Atai.Models.ServiceUsers", b =>
                {
                    b.HasOne("homework_64_Atai.Models.ServiceCompany", "Service")
                        .WithMany("ServiceUsers")
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("homework_64_Atai.Models.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
